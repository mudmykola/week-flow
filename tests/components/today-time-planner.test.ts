...
describe('Today Time Zones UI contract', () => {
  it('connects configurable zones, floating lunch and automatic planning', () => {
    ...
    const zoneStyles = read('app/presentation/assets/css/components/today/today-time-zone.css')
    ...
    expect(zoneStyles).toContain('today-time-zone--tray .today-time-zone__tasks')
