...
const page = readFileSync(resolve(process.cwd(), 'app/presentation/components/week/WeekWorkspace.vue'), 'utf8')
const bulkActions = readFileSync(resolve(process.cwd(), 'app/presentation/components/week/WeekBulkActions.vue'), 'utf8')
...
describe('Week Board 3.0 contract', () => {
  ...
  it('provides contextual drag, smart create, top three and responsive navigation', () => {
    ...
    expect(bulkActions).toContain('blockedByTaskId')
  })
})
