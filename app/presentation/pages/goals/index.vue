    ...
    >
      ...
      >
        <div class="flex items-start justify-between gap-3">
          <div>
            <h2 class="font-display">{{ goal.title }}</h2>
            <p
        ...
        <input
          ...
          @change="updateProgress(goal.id, Number(($event.target as HTMLInputElement).value))"
        />
      </article>
    </section>
  </div>
