import { createTask, deleteTask, fetchTasks, moveWeekTasks, updateTask } from '~/data/repositories/tasksRepository'
...
export const useTasksStore = defineStore('tasks', () => {
  ...
  const filteredTasks = computed(() =>
    filterProjectId.value
      ? tasks.value.filter(t => t.projectId === filterProjectId.value)
      : tasks.value
  )
