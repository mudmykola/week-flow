...
- **Backlog + Capacity** — окремий потік пріоритизації нерозпланованих задач і контроль реальної місткості робочого тижня. Підтримуються оцінки часу, масове планування, перевантаження та автоматичне заповнення вільних днів.
- **Inbox Processing 2.0** — контекстне швидке захоплення думок без забруднення дошок. Записи можна перетворити на задачі, плани на сьогодні, стікери, проєкти або командні цілі.
